...
export const siteNavigation: NavItem[] = [
  {
    ...
    children: [
      ...
      { label: "Facchinaggio hotel Roma", href: "/pulizie-hotel-roma/facchinaggio/" },
      { label: "Governanti hotel Roma", href: "/pulizie-hotel-roma/governanti/" },
      { label: "Bellboy hotel Roma", href: "/pulizie-hotel-roma/bellboy/" },
      { label: "Supervisore di zona hotel", href: "/pulizie-hotel-roma/supervisore-zona/" },
