...
function HeroVariantA() {
  return (
    <section className="px-[16px] md:px-[56px] pt-[40px]">
      <div className="rounded-[28px] border border-[rgba(0,0,0,0.08)] bg-white px-[20px] md:px-[34px] py-[24px] md:py-[34px]">
        <div className="mb-[18px]">
          <SectionBadge>Proposta A · Split Editorial</SectionBadge>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-[1.05fr_0.95fr] gap-[22px] md:gap-[30px] items-stretch">
          <div>
            <h2 className="m-0 font-serif text-[38px] md:text-[56px] leading-[1.02] tracking-[-0.025em] text-[#161714]">
              {hotelPageContent.hero.title}
            </h2>
            <p className="mt-[18px] max-w-[980px] text-[16px] md:text-[19px] leading-[1.55] text-[#3a3b36]">
              {hotelPageContent.hero.subtitle}
            </p>
          ...
          <div className="relative min-h-[280px] md:min-h-full overflow-hidden rounded-[22px]">
            ...
            <div className="absolute bottom-[14px] left-[14px] right-[14px] rounded-[14px] bg-[rgba(255,255,255,0.9)] px-[12px] py-[10px]">
              <div className="text-[13px] text-[#161714]">✔ Squadre formate per strutture ricettive</div>
              <div className="text-[13px] text-[#161714] mt-[4px]">✔ Referente dedicato per ogni hotel</div>
            </div>
          </div>
        </div>
      </div>
      <div className="mt-[14px] grid grid-cols-1 md:grid-cols-4 gap-[10px] rounded-[20px] border border-[rgba(0,0,0,0.06)] bg-[#fbf9f3] px-[16px] py-[14px]">
        {hotelPageContent.hero.trust.map((item) => (
          <div key={item} className="text-[14px] text-[#161714] flex items-start gap-[8px]">
            <span className="text-[#99cc33] mt-[1px]">✔</span>
            <span>{item}</span>
...
function HeroVariantB() {
  return (
    <section className="relative left-1/2 w-screen -translate-x-1/2 pt-[40px]">
      <div className="mx-auto w-[calc(100vw-48px)] overflow-hidden rounded-[32px]">
        <div className="relative min-h-[420px] md:min-h-[520px]">
          <Image
            ...
            sizes="100vw"
          />
          <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(0,0,0,0.38)_0%,rgba(0,0,0,0.7)_100%)]" />
          <div className="relative mx-auto w-full max-w-[1440px] px-[16px] md:px-[56px] py-[26px] md:py-[40px]">
            <div className="max-w-[980px]">
              <SectionBadge dark>Proposta B · Dark Panel</SectionBadge>
              <h2 className="mt-[18px] m-0 font-serif text-[38px] md:text-[56px] leading-[1.02] tracking-[-0.025em] text-[#fbf9f3]">
                {hotelPageContent.hero.title}
              </h2>
...
function HeroVariantC() {
  const kpis = [
    { v: "24/48h", l: "Attivazione media" },
    { v: "1", l: "Referente dedicato" },
    { v: "Roma", l: "Copertura completa" },
  ];
  return (
    <section className="px-[16px] md:px-[56px] pt-[40px]">
      <div className="rounded-[28px] border border-[rgba(0,0,0,0.08)] bg-white px-[20px] md:px-[34px] py-[24px] md:py-[34px]">
        <SectionBadge>Proposta C · Manifesto + KPI</SectionBadge>
        <h2 className="mt-[18px] m-0 font-serif text-[38px] md:text-[56px] leading-[1.02] tracking-[-0.025em] text-[#161714]">
          {hotelPageContent.hero.title}
        </h2>
        <p className="mt-[18px] max-w-[980px] text-[16px] md:text-[19px] leading-[1.55] text-[#3a3b36]">
          {hotelPageContent.hero.subtitle}
        ...
        <div className="mt-[20px] grid grid-cols-1 md:grid-cols-3 gap-[12px]">
          {kpis.map((k) => (
            <div key={k.l} className="rounded-[16px] border border-[rgba(0,0,0,0.08)] bg-[#fbf9f3] px-[16px] py-[14px]">
              <div className="font-serif text-[32px] leading-[1] text-[#161714]">{k.v}</div>
              <div className="mt-[6px] text-[13px] text-[#3a3b36]">{k.l}</div>
            </div>
          ))}
        </div>
        <div className="mt-[24px] flex flex-col sm:flex-row gap-[12px]">
