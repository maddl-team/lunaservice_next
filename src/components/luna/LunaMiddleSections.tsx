...
export function LunaMiddleSections() {
  ...
  return (
    <>
      <section className="px-[16px] md:px-[56px] pb-[80px] md:pb-[120px] pt-[96px] md:pt-[160px]">
        <div className="grid grid-cols-1 md:grid-cols-[1.1fr_1fr] items-start gap-[28px] md:gap-[80px]">
          <div>
      ...
      <SectionShell
        fullBleed
        outerClassName="text-[#fbf9f3]"
        bgClassName="bg-[#161714]"
        innerClassName="rounded-t-[32px]"
        boxedClassName="px-[16px] md:px-[56px] pb-[80px] md:pb-[120px] pt-[70px] md:pt-[120px]"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-6 gap-[16px]">
            {services.map((service, index) => (
              <ServiceCard key={service.n} featured={index === 0} {...service} />
            ))}
        </div>
      </SectionShell>
      ...
      <SectionShell
        ...
        outerClassName="text-[#fbf9f3]"
        bgClassName="bg-[#161714]"
        innerClassName="rounded-b-[32px]"
        boxedClassName="px-[16px] md:px-[56px] pb-[90px] md:pb-[160px] pt-[60px] md:pt-[80px]"
      >
            ...
            <div className="mb-[40px] md:mb-[64px] grid grid-cols-1 md:grid-cols-2 items-end gap-[24px] md:gap-[80px]">
              ...
              {whyItems.map((item, idx) => (
                <FeatureCard key={item.num} num={item.num} progress={`0${idx + 1} di 04`} title={item.title} body={item.body} />
              ))}
              </div>
            </div>
      </SectionShell>
